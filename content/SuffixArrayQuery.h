 ...
 * inputs are 0-based and ranges are given and returned as inc-ex
 * Time: len_lcp: O(1), cmp_sub: O(1), find_str: O(log(n))
 * Status: Tested
*/
struct SAQuery{
    ...
    } //returns [) range of the suffix array, substr is given [)
